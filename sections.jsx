// sections.jsx — Hero, Services, MyAppts, Footer

function Nav({ section, onNav, hasAppts }) {
  return (
    <nav className="nav">
...
function MyAppts({ appts, onCancel, onBookNew }) {
...
Object.assign(window, { Nav, Hero, Services, MyAppts, Footer });
