// app.jsx — Main App: routing, state, persistence
...
function App() {
  ...
  const [modal, setModal] = React.useState(null); // 'review' | 'confirmed' | null
...
function BookSection({ selected, onPick, viewMode, setViewMode, bookedAppts, canConfirm, openReview, onClear }) {
...
Object.assign(window, { App, BookSection });
