// booking.jsx — Modal forms & confirmation

function BookingModal({ open, mode, selected, onClose, onConfirm }) {
...
function CancelModal({ open, appt, onClose, onConfirm }) {
...
Object.assign(window, { BookingModal, CancelModal });
